...
docker build --platform amd64  -t kubeconfig-builder-job:1.0 -f Dockerfile .
docker tag kubeconfig-builder-job:1.0 us-west1-docker.pkg.dev/prow-open-btr/prow-sandbox-registry/kubeconfig-builder-job:1.0
docker push us-west1-docker.pkg.dev/prow-open-btr/prow-sandbox-registry/kubeconfig-builder-job:1.0
